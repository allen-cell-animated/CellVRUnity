...
{
	[HelpURL("http://www.utopiaworx.com/Helios/Helios_Look.aspx")]
[AddComponentMenu("Camera-Control/Smooth Mouse Look")]
public class HeliosLook : MonoBehaviour {
		...
		{			
			...
			else
			{
				...
				{			
					...
					rotationY += FrameController.mouseY * sensitivityY;
					rotationX += FrameController.mouseX * sensitivityX;
